...
@section("content")
    <div class="bg-black">
        ...
        <div class="p-9 text-gray-700 font-sans quicksand ">
            ...
            <h1 class="text-4xl mb-4"><span class=" border-b-4 border-pink-400 text-white text-center">Courses Offered</span></h1>
                ...
                @foreach($courses as $course)
                    <div class="bg-gray-300 overflow-hidden hover:bg-pink-100 border border-gray-200 p-5 rounded">
                        <div class="m-2  text-justify text-sm">
                            ...
                            <div>
                                <h2 class="font-bold text-xs mb-5">Course Category: {{$course["type_of_course"]["course_type"]}}</h2>
                            </div>
                            <p class="text-xs">
